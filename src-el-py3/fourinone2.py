...
def genFourinone(latticedir, stylesheetdir, artDictbin, mis, mus, fourinoneinternalfile):
    ...
    print("")
    print("MIS (red box):", end=' ')
    for e in misBin:
        print(decodeToName(e, artDictbin), end=' ')
        #print e,

    print("")
    print("MCS (green box):", end=' ')
    for e in mcsBin:
        print(decodeToName(e, artDictbin), end=' ')
        #print e,

    print("")
    print("MUS: (green octagon)", end=' ')
    for e in musBin:
        print(decodeToName(e, artDictbin), end=' ')
        #print e,

    print("")
    print("MAA: (cyan diamond)", end=' ')
    for e in maaBin:
        print(decodeToName(e, artDictbin), end=' ')
        #print e,
